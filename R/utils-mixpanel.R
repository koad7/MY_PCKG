...
#' 
#' @description 
#' If a download directory exist it will be cleaned other wise a new one is created.
#'
#' Set-up download dir
#' @param dir name
#' @export
...
#' 
#' @description 
#' Remove the specify 'dir' directory
#'
#' Clean download dir
#' @param dir name
#' @export
...
#' 
#' @description 
#' Preprocess mixpanel data. 
#' Converti Timestamp and setting condition for user_type data. 
#'
